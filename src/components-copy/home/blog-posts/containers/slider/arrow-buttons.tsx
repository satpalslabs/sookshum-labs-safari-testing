/**
 * This component contains arrow buttons of slider.
 */
...
function ArrowButtons({
  ...
  return (
    <div className="absolute right-[6%] lg:right-[4%] -top-[20%] lg:-top-[44%] sm:right-4  xs:hidden">
      <div className="flex gap-5">
        <button className="previous-blog">
          <svg
            width="14"
            height="9"
            viewBox="0 0 14 9"
        ...
        <button className="next-blog arrow">
          <svg
            width="14"
            height="9"
            viewBox="0 0 14 9"
