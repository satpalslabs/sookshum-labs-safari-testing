...
const ChooseUs = () => {
  ...
  return (
    <div>
      <div
        ref={ref}
        className="px-[80px] lg:px-10 xs:px-5 pt-[120px] md:pt-[90px] sm:pt-[70px] xs:pt-[60px]  flex items-center bg-black overflow-hidden max-w-[1920px] mx-auto"
      >
        <div className="flex sm:flex-col gap-[80px] md:gap-[60px] sm:gap-12 justify-between ">
          <H2>
            <div className="text-wrap text-[47px] lg:text-[36px] sm:text-[26px] leading-[1.1] w-[590px] xxl:w-[90%] lg:w-[80%] sm:w-full lg:tracking-normal tracking-tight">
              ...
              workflow and requirements of your company. Here’s how we can help
              you:
            </div>
          </H2>
      ...
      >
        ...
        >
          <div className="w-[80%] sm:w-[90%] text-wrap xs:w-full text-center mx-auto xs:text-wrap">
