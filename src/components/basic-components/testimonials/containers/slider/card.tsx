  ...
  >
    <div className="w-fit h-full relative z-50 overflow-hidden rounded-[32px] bg-black sm:rounded-[20px] ">
      <div
        ...
        className={`slideCard h-[360px] max-w-fit w-max  min-w-[408px] md:h-[300px] xs:h-[220px] p-4 py-8 bg-innerContainer shadow-buttonInset rounded-[32px] sm:rounded-[20px]  transition-all duration-500 bg-slider-bg-size bg-[100%_100%] hover:bg-[0%_0%] cursor-pointer overflow-hidden flex flex-col xs:rounded-2xl gap-6 xs:gap-4 lg:p-3 lg:py-4 lg:rounded-[26px] xs:p-[10px]`}
      >
        <Image
          height={72}
          width={600}
