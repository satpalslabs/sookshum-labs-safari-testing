    ...
    <div
      className={`absolute  ${
        props.showContent == "video"
          ...
          : `scale-[1.0] xxl:left-[3%] w-screen h-[520px] xs:-top-[1%] xs:scale-[3] sm:h-[290px] xs:h-[180px] lg:h-[411px]  xxl:h-[520px] xxl:-top-[20%] -top-[10%] ${props.style.sourceStyle}`
    ...
    <div
      className={`absolute  ${
        props.showContent == "video"
          ...
          : `xxl:left-[50%] xxl:-translate-x-[50%] scale-[1.4] w-screen h-[520px] xs:-top-[1%] xs:scale-[3] sm:h-[300px] xs:h-[180px] lg:h-[421px]  xxl:h-[90%] xxl:-top-[8%] -top-[10%]`
