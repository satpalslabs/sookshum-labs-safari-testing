  ...
  <OuterComponent>
    <OuterFlexComponent>
      <SectionHeader
        ...
        description="We adopt a rapid and reliable approach with the best Directus CMS services for organisations to achieve their business goals. Eager to know what our expertise can contribute to your business? Here we go!"
      ...
      >
        <div className=" leading-[1.4] text-wrap text-center tracking-[-0.02em] capitalize">
          Our <span className="italic font-light">Directus CMS</span>{" "}
...
const MainContainer: React.FC = () => {
  ...
  return (
    <div
      ref={ref}
      className="grid grid-cols-2 sm:gap-3 lg:gap-4 gap-5 w-full xs:grid-cols-1"
    >
          ...
          <div className="flex flex-col justify-between lg:p-3 p-4 gap-[28px] lg:gap-5 h-full">
            ...
            <div className="flex flex-col gap-4 lg:gap-3 sm:gap-2 ">
              ...
              <Description
                ...
                classes="grow-0 h-fit text-whiteTextPrimary sm:text-xs lg:text-base text-lg font-normal"
              />
            </div>
          </div>
        </Card>
