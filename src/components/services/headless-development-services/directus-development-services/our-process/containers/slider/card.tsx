    ...
    <div className={`w-fit pr-[37px] cursor-pointer  lg:pr-3`}>
      <div className=" flex w-fit flex-col gap-[12px] grow xs:p-1">
        <div className="flex gap-3 w-fit relative items-center overflow-visible ">
          ...
          {/* {isLast && ( */}
          <div
            className={`font-poppins absolute overflow-visible right-0 translate-x-[50px] w-[50px] items-center text-[30px] md:leading-5 md:text-base sm:text-sm text-white font-medium rocket flex scale-0 transition-all ease-in-out  ${
              !isLast && "!scale-0"
            }`}
          >
            🚀
