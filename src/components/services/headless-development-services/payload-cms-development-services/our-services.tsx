  ...
  <OuterComponent>
    <OuterFlexComponent>
      <SectionHeader
        ...
        description="We adopt a rapid and reliable approach with the best Payload CMS services for organisations to achieve their business goals. Eager to know what our expertise can contribute to your business? Here we go! "
      ...
      >
        <div className=" leading-[1.4] text-wrap text-center tracking-[-0.02em] capitalize">
          Our <span className="italic font-light">Payload CMS</span> Development
          services
        </div>
      </SectionHeader>
      <MainContainer />
...
const MainContainer: React.FC = () => {
  ...
  return (
    <div
      ref={ref}
      className="grid grid-cols-3 sm:grid-cols-2 sm:gap-3 lg:gap-4 gap-5 w-full xs:grid-cols-1"
    >
