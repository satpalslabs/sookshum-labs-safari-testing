...
const LetsConnect: React.FC = () => (
    <OuterComponent>
      <div className="flex  shadow-buttonInset bg-innerContainer rounded-[32px] sm:rounded-[20px] w-full justify-center items-center xs:w-full flex-col gap-5 md:gap-0 xs:gap-[17px] px-[69px] grow md:px-[51px] sm:px-[28px] sm:py-[34px] h-fit py-[72px] xs:py-[28px] xs:px-6 ">
        <H2>
          <div className="text-center text-wrap text-5xl lg:text-4xl sm:text-[26px]  leading-[60.6px]  lg:leading-[45px] sm:leading-[33px] lg:tracking-normal font-semibold tracking-tight capitalize w-[80%] mx-auto 3xs:w-full">
            Let’s build a cutting-edge Webflow site for your company{" "}
          </div>
        </H2>
        <PrimaryButton
          icon={true}
