...
const content_heroSection: HeroSection = {
  ...
  style: {
    ...
    gradientDivStyle:
      "scale-[1.0] w-screen xxl:left-[50%] xxl:-translate-x-[50%] w-screen xxl:h-[620px] h-[540px] lg:h-[461px] sm:h-[490px] xs:h-[510px] 2xs:h-[590px]   xxl:bottom-[15%] bottom-[20%] lg:bottom-[4%]  sm:bottom-[10%]  xs:bottom-[-0%] 2xs:bottom-[0%] ",
  },
  aboutPage:
