    ...
    <OuterComponent>
      <div className="flex flex-row xs:flex-col gap-5">
        ...
        <div className="w-full text-2xl md:text-xl leading-[38.4px] md:leading-8 tracking-[-0.02em]">
          <p>
            Whether you need a partner to bring your idea to life, maintain an
            existing codebase, or strengthen your engineering team, we’re here
            to help.
          </p>
          <p className="my-5">Our expertise spans across:</p>
