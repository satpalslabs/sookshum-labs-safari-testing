...
const SingleCard: React.FC<{
  ...
  >
    <div
      className={`shadow-buttonInset transition-all duration-1000 p-6 sm:p-[18px] h-full pb-[60px] sm:pb-[48px] xs:pb-[34px] rounded-[32px] sm:rounded-[24px] border-[1.5px] bg-[#28282866] cursor-pointer hover:border-borderPrimary ${
        isInView
          ? "border-viewportBorder grayscale-0"
          : "border-transparent grayscale"
      } ${index == 1 && "bg-gradientOnHover"}`}
      style={{
