...
const SideNavigation: React.FC<{
  ...
  >
    ...
    >
      <div
        className={`!py-[12px] w-fit !px-8 md:!px-[20px] !border-borderDarkButton [backdrop-filter:blur(100px)] !text-secondary sm:!py-2 sm:!px-3 flex gap-2 items-center !rounded-full !border-solid border !bg-darkButton !shadow-buttonInset text-center flex-nowrap group-hover:!bg-buttonGradient !normal-case !text-[16px] md:!text-sm sm:!text-[11px] ${
      ...
      >
        <span
          className={` font-medium font-poppins flex-nowrap ${
            props.ind == props.active ? "text-primary" : "text-darkButton_text"
          }`}
        >
          {`0${props.ind + 1}.`}
        </span>
