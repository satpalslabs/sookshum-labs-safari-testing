...
const OurServicesMainContainer = () => {
  ...
  return (
    <div ref={ref} className="w-full grid grid-cols-3 grid-rows-3 gap-5 sm:gap-3 xs:grid-cols-1 xs:grid-rows-9">
...
const SingleCard: React.FC<{ isInView: boolean; data: ServiceType }> = ({
  ...
  <div className="relative rotate-0 w-fit h-full ">
    <Card style="!rounded-[32px] !p-8 !pb-8 lg:!p-7 sm:!p-6 xs:!p-5 justify-between !gap-4 lg:!gap-8 sm:!gap-[60px] xs:!gap-3 h-full" isInView={isInView}>
