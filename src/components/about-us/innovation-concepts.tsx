...
const InnovationConcepts: React.FC = () => {
  ...
  return (
    <section
      ref={ref}
      className={`px-[80px] lg:px-10 xs:px-5 pt-[120px] md:pt-[90px] sm:pt-[70px] xs:pt-[60px] flex flex-col items-center gap-[40px] lg:gap-[30px] xs:gap-3 bg-black overflow-hidden max-w-[1920px] mx-auto ${
